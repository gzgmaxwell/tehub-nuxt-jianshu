<template>
  ...
  <a-row
    type="flex"
    justify="center"
    style="background-color: #f9f9f9; min-height: 100vh; padding-top: 66px"
  >
    <a-col :span="15">
      <a-row>
        <a-col :span="2">
            ...
            <div class="author-info">
              ...
              <div class="author-des">
                ...
                <a-row type="flex" align="middle" style="margin-top: 6px">
                  ...
                  <span class="ip">
                    {{
                      dayjs(noteData.created_at).format('YYYY-MM-DD HH:mm:ss')
                    }}
                  </span>
        ...
        <a-col :span="6" class="right-sider">
          <div class="right-author">
            <div
              class="author-des"
              style="border-bottom: 1px solid #f0f0f0; padding-bottom: 10px"
            >
              <a-row type="flex" align="middle">
